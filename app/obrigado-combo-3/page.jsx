export const metadata = {
    title: 'Compra Aprovada — Combo Essencial | Atlas das Receitas',
    description: 'Escolha os 3 ebooks do seu Combo Essencial.',
...
export default function ObrigadoCombo3Page() {
    return (
        <div
            style={{
                minHeight: '100dvh',
            ...
            <div style={{ width: '100%', maxWidth: '560px' }}>
                ...
                >
                    ...
                    <p style={{ textAlign: 'center', fontFamily: 'var(--font-display)', fontWeight: 600, fontSize: '1.05rem', color: '#FCD34D', marginBottom: '0.75rem' }}>
                        Escolha os 3 ebooks que deseja receber.
                    </p>
                    ...
                    >
                        <input type="hidden" name="_subject" value="Nova seleção Combo Essencial - Atlas das Receitas" />
